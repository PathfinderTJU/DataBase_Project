...
function cidFunction(){
    ...
    let uri = "http://localhost:80/api/get_class_course_all?fieldName=cid&value=" + cid + "&class=" + className + "&grade=" + grade;
    ...
    var average_uri = "http://localhost:80/api/get_class_course_grade?fieldName=cid&value=" + cid + "&class=" + className + "&grade=" + grade;
    ...
    var chartData = [];
    var range_uri = "http://localhost:80/api/get_class_range?grade=" + grade + "&class=" + className + "&fieldName=cid&value=" + cid + "&low=";
...
function cnameFunction(){
    ...
    let uri = "http://localhost:80/api/get_class_course_all?fieldName=cname&value=" + cname + "&class=" + className + "&grade=" + grade;
    fetch(uri).then(res => res.json()).then(function(result){
        var table = document.getElementById("score_table");
        score_table.innerHTML = "";
        if (result[0].code === "500") {
    ...
    //平均
    var average_uri = "http://localhost:80/api/get_class_course_grade?fieldName=cname&value=" + cname + "&class=" + className + "&grade=" + grade;
    fetch(average_uri).then(res => res.json()).then(function(result){
        if (result.code === "500"){
            average_block.innerHTML = "无成绩";
        }else{
    ...
    //图标
    var chartData = [];
    var range_uri = "http://localhost:80/api/get_class_range?grade=" + grade + "&class=" + className + "&fieldName=cname&value=" + cname + "&low=";
    fetch(range_uri + "90&high=100").then(res => res.json()).then(function(res){
        if (res.code === "500"){
            chartData.push(0);
        }else{
